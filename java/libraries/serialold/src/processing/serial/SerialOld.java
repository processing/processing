 ...
 */
  public SerialOld(PApplet parent) {
 ...
 */
  public SerialOld(PApplet parent, int irate) {
 ...
 */
  public SerialOld(PApplet parent, String iname, int irate) {
    this(parent, iname, irate, dparity, ddatabits, dstopbits);
  }

  public SerialOld(PApplet parent, String iname) {
