...
<br>
<a href="<?php echo reflink("PImage2") ?>">PImage2</a><br>
<a href="<?php echo reflink("PImage2_get") ?>">get()</a><br>
<a href="<?php echo reflink("PImage2_set") ?>">set()</a><br>
<a href="<?php echo reflink("PImage2_mask") ?>">mask()</a><br>
<a href="<?php echo reflink("PImage2_loadPixels") ?>">loadPixels()</a><br>
<a href="<?php echo reflink("PImage2_pixels") ?>">pixels</a><br>
</div>
<?php
