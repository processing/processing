...
//              System.out.println("  " + PUtil.binary(e.getModifiersEx()));
////            if (mods.length() > 0) {
//              System.out.println("  mods extext = " + mods + " " + mods.length() + " " + PUtil.hex(mods.charAt(0)));
//            }
    ...
    if (tokenMarker == null) {
      ...
      for (;;) {
        ...
        if (id != Token.NULL) {
          ...
          cf.append(PUtil.hex(styles[id].getColor().getRGB() & 0xFFFFFF, 6));
          cf.append(";\">");
