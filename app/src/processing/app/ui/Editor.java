...
public abstract class Editor extends JFrame implements RunnerListener {
  ...
  static public final int SCROLL_COUNT = 20;
...
//      boolean active = textarea.isSelectionActive();
   ...
   * bottom of the menu.
   * <P>
   * <B>Implementation note:</B> The default number of items to display at a
   * time is 15, and the default scrolling interval is 125 milliseconds.
   * <P>
   */
  public static class MenuScroller {
    ...
    private final MouseScrollListener mouseScrollListener = new MouseScrollListener();
     ...
     */
    public static MenuScroller setScrollerFor(JMenu menu, int scrollCount,
                                              int interval, int topFixedCount,
    ...
    public MenuScroller(JPopupMenu menu, int scrollCount, int interval,
      ...
      menu.addMouseWheelListener(mouseScrollListener);
    }
    ...
    public void dispose() {
      if (menu != null) {
        ...
        menu.removeMouseWheelListener(mouseScrollListener);
        menu = null;
      }
    }
    ...
    private void refreshMenu() {
      if (menuItems != null && menuItems.length > 0) {
        ...
        firstIndex = Math
          .min(menuItems.length - bottomFixedCount - scrollCount, firstIndex);
        ...
        menu.setPreferredSize(new Dimension(preferredWidth, menu
    ...
    /**
     * Calculates the number for scrollCount such that the menu fills the
     * available vertical space from the point (mouse press) to the bottom of
     * the screen.
     * 
     * @param c
     *          The component on which the point parameter is based
     * @param pt
     *          The point at which the top of the menu will appear (in component
     *          coordinate space)
     * @param item
     *          A menuitem of prototypical height off of which the average
     *          height is determined
     * @param bottomFixedCount
     *          Needed to offset the returned scrollCount
     * @return the scrollCount
     */
    public static int scrollCountForScreen(Component c, Point pt,
                                           JMenuItem item, int bottomFixedCount) {
