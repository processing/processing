 ...
 */
public class Base {
  static final int VERSION = 5;//114;
  static final String VERSION_NAME = "0005";//"0114 Beta";
    ...
    if (pref != null) {
      ...
      try {
        ...
        */
        ...
        dataFolder = new File(libraryFolder, "MobileProcessing");
      ...
      try {
        ...
        dataFolder = new File(appDataPath, "MobileProcessing");
      ...
      dataFolder = new File(home, ".mobileprocessing");
    }
