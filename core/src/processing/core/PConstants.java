...
//  static final String E2D = PGraphicsDanger2D.class.getName();
   ...
   * 6.28318530717958647693. It is the ratio of the circumference
   * of a circle to its radius. It is useful in combination with the
   * trigonometric functions <b>sin()</b> and <b>cos()</b>.
   *
   * ( end auto-generated )
   * @webref constants
   * @see PConstants#PI
   * @see PConstants#HALF_TAU
   * @see PConstants#QUARTER_TAU
   */
  static final float TAU = (float) (2.0 * Math.PI);
  /**
   * HALF_TAU is an alias for PI, a mathematical constant with the value
   * 3.14159265358979323846. It is half the ratio of the circumference
   * of a circle to its radius. It is useful in combination with the
   * trigonometric functions <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
   ...
   * @see PConstants#PI
   */
  static final float HALF_TAU = (float) Math.PI;
  /**
   * QUARTER_TAU is an alias for HALF_PI, a mathematical constant with the value
   * 1.57079632679489661923. It is one quarter the ratio of the circumference
   * of a circle to its radius. It is useful in combination with the
   * trigonometric functions <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
   ...
   * @see PConstants#PI
   */
  static final float QUARTER_TAU = (float) (Math.PI / 2.0);
