...
import static processing.core.PUtil.*;
    ...
    void add(Object object, Method method) {
      if (findIndex(object) == -1) {
        if (objects == null) {
          ...
          objects = (Object[]) PUtil.expand(objects);
          methods = (Method[]) PUtil.expand(methods);
        }
...
//    applet.fullScreen |= present;
    ...
    applet.args = PUtil.subset(args, argIndex + 1);
