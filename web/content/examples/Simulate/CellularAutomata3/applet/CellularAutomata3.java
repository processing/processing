import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class CellularAutomata3 extends PApplet {// Cellular Automata 3
...
public void seed()
{
  ...
  {
    int cX = PApplet.toInt(random(width));
    int cY = PApplet.toInt(random(height));
    int c;
    float r = random(1);
    if (r < 0.25f) c = spore1;
