import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class MultipleParticleSystems extends PApplet {// Multiple Particle Systems
...
public void mousePressed() {
  psystems.add(new ParticleSystem(PApplet.toInt(random(5,25)),new Vector3D(mouseX,mouseY)));
}
