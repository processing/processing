import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class CustomTool extends PApplet {/**
 * Custom Tool. 
 * 
...
float l = 30.0f; // Length of the 'leg'
float h = 60.0f; // Height of the 'leg'
...
static public void main(String args[]) {   PApplet.main(new String[] { "CustomTool" });}}