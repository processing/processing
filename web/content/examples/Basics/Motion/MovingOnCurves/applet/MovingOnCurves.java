import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class MovingOnCurves extends PApplet {// Moving along curves
...
int e2_size = 10;
float e2_x, e2_y = 0;
float e2_speed = 0.80f;
int e2_direction = 1;

// Variables for third ellipse
int e3_size = 14;
float e3_x, e3_y = 0;
float e3_speed = 0.65f;
int e3_direction = 1;
