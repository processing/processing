import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class ArrayObjects extends PApplet {// Array Objects
...
class Module {
  ...
  Module(float imx, float imy, float ixxx, float iyyy, float ispeed) {
    mx = imy;
    my = imx;
    xxx = PApplet.toInt(ixxx);
    yyy = PApplet.toInt(iyyy);
    speed = ispeed;
  }
