import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class Vertices extends PApplet {public void setup() {/**
 * Vertices. 
 * 
...
noLoop(); } static public void main(String args[]) {   PApplet.main(new String[] { "Vertices" });}}