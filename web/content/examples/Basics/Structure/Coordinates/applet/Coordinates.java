import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class Coordinates extends PApplet {public void setup() {/**
 * Coordinates. 
 * 
...
rect(110, 55, 40, 36);
noLoop(); } static public void main(String args[]) {   PApplet.main(new String[] { "Coordinates" });}}