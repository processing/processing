import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class Recursion2 extends PApplet {// Recursion
...
{                    
  ...
  if(level > 1) {
    level = level - 1;
    int num = PApplet.toInt(random(2, 6));
    for(int i=0; i<num; i++) {
